...
export class CustomerSchema extends BaseModel {
  static $columns = ['cpf', 'createdAt', 'email', 'fullName', 'id', 'phone', 'updatedAt'] as const
...
export class TransactionSchema extends BaseModel {
  static $columns = ['amount', 'createdAt', 'description', 'gatewayId', 'id', 'status', 'updatedAt', 'userId'] as const
